                ...
                <div class="border rounded cart-list-divider">
                    <div class="row bg-white">
                        ...
                        <div class="col-md-3 py-5">
                            <div>
                                <button class="btn bg-light border rounded-circle"><i class="fa fa-minus" aria-hidden="true"></i></button>
                                <input type="text" value="1" class="form-control w-25 d-inline">
                                <button class="btn bg-light border rounded-circle"><i class="fa fa-plus" aria-hidden="true"></i></i></button>
